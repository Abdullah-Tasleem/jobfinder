            ...
            @elseif(auth()->user()->type === 'company')
                <div>
                    ...
                    <x-text-input id="company_name" name="company_name" type="text" class="mt-1 block w-full"
                        :value="old('company_name', $user->company_name)" autocomplete="company_name" />
                ...
                <div>
                    ...
                    <x-text-input id="company_website" name="company_website" type="text" class="mt-1 block w-full"
                        :value="old('company_website', $user->company_website)" autocomplete="website" placeholder="https://example.com" />
